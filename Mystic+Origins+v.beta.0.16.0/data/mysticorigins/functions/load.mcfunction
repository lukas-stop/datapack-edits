...
scoreboard objectives add mysticdata2 dummy
...
scoreboard players set #ver2 mysticdata 16
...
execute unless score #loadmsgcheck mysticdata matches 1 run scoreboard players set loadmsgcheck mysticdata 0
